const games = [
    ...
    // Шутеры
    {
        ...
        description: "Данная игра повествует о войне Леона."
    },
    {
        id: 8,
    ...
    },
     {
        ...
        genre: "shooter",
        image: "https://i.ytimg.com/vi/8njSFfziTF8/maxresdefault.jpg",
        description: "Разрушающее присутствие захватило Федеральное бюро контроля... Только вы в силах остановить его."
    },
     {
        id: 10,
        title: "REMNANT II",
        genre: "shooter",
        image: "https://avatars.mds.yandex.net/i?id=8281a774488aafcc07e41738202a99e7_l-10310955-images-thumbs&n=13",
        description: "Выжившим представителям человечества предстоит отправиться в жуткие миры и вступить в бой с новыми беспощадными тварями и богоподобными боссами. Исследуйте глубины неизведанного в одиночку или вместе с друзьями и помешайте злу разрушить реальность."
    },
    {
        id: 11,
    ...
    },
    {
        ...
        title: "R.E.P.O.",
        genre: "indie",
        image: "https://avatars.mds.yandex.net/i?id=88a7fe9e8a54109b807c81a3a6893d5dc02b3c74-5681290-images-thumbs&n=13",
        description: "Советский хоррор-квест от российских разработчиков. Расследуйте тайны заброшенного НИИ в атмосфере 80-х.",
...
function openModal(game) {
    ...
    downloadBtn.onclick = function() {
        ...
        alert(`Начато скачивание "${game.title}"!`);
        // window.location.href = game.downloadLink; // Если есть реальные ссылки
    };
